module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      all: ['Gruntfile.js', 'karma.conf.js',  'src/gameLogic.js', 'src/game.js', 'src/hexagon.js']
    },
    karma: {
      unit: {
    ...
    watch: {
      files: ['src/gameLogic.js', 'src/game.js', 'src/hexagon.js'],
    ...
    concat: {
      ...
      dist: {
        ...
        src: ['src/gameLogic.js', 'src/game.js', 'src/hexagon.js'],
