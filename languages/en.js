window.angularTranslationsLoaded('en', {
  ...
  "RULES_SLIDE3": "The left button is to switch tile pattern, middle button to rotate tiles and right button to confirm and both tokens will move along the path on the board if possible (might across many blocks).",
